...
class ChapterGenerator:
    ...
    def strict_prompt(
        ...
        base = (
            ...
            "   📌 Ссылка — [N] или [N, с. X] (или [N, с. X–Y]).\n"
            "   ❌ ЗАПРЕЩЕНО выдумывать номера страниц: если страница не\n"
            "      известна, ставь [N], а не выдуманный [N, с. 45].\n"
            "   ❌ ЗАПРЕЩЕНО: [N, с. ], [N, c. X], [N, с. без цифры.\n\n"
